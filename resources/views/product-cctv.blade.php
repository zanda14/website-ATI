...
<head>
  ...
  <title>CCTV Surveillance – ATI</title>
...
<section class="prod-section">
  <div class="container">
    <div class="row g-4">
      ...
      <div class="col-md-6 col-lg-4"><div class="prod-card"><img class="prod-card-img" src="https://placehold.co/480x200/e8ecf8/0b1638?text=IP+Camera" alt="IP Camera"/><div class="prod-card-body"><h4>IP CAMERA</h4><p>Advanced Technologies, Inspiring Security. Kamera IP resolusi 4K dengan AI smart detection, night vision, dan remote monitoring via aplikasi mobile.</p><span class="brand-tag">Hikvision</span><span class="brand-tag">Dahua</span><span class="brand-tag">Axis</span></div></div></div>
      <div class="col-md-6 col-lg-4"><div class="prod-card"><img class="prod-card-img" src="https://placehold.co/480x200/e8ecf8/0b1638?text=Analog+Camera" alt="Analog Camera"/><div class="prod-card-body"><h4>ANALOG CAMERA</h4><p>Simply the Technology, Simply the Surveillance. Kamera analog HD-TVI/AHD dengan kualitas gambar tajam dan instalasi yang mudah.</p><span class="brand-tag">Hikvision</span><span class="brand-tag">Dahua</span></div></div></div>
      <div class="col-md-6 col-lg-4"><div class="prod-card"><img class="prod-card-img" src="https://placehold.co/480x200/e8ecf8/0b1638?text=Special+Camera" alt="Special Camera"/><div class="prod-card-body"><h4>SPECIAL CAMERA SYSTEM</h4><p>Smarter, Simpler, Better, Cameras and More. Kamera khusus termal, PTZ, fisheye 360°, dan LPR untuk kebutuhan keamanan ekstra.</p><span class="brand-tag">Axis</span><span class="brand-tag">Bosch</span><span class="brand-tag">Pelco</span></div></div></div>
    </div>
  </div>
</section>
