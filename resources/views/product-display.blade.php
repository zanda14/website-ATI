...
<head>
  ...
  <title>Display System – ATI</title>
...
<section class="prod-section">
  <div class="container">
    <div class="row g-4">
      ...
      <div class="col-md-6 col-lg-4"><div class="prod-card"><img class="prod-card-img" src="https://placehold.co/480x200/e8ecf8/0b1638?text=Videotron" alt="Videotron"/><div class="prod-card-body"><h4>VIDEOTRON</h4><p>1,5 Tiles for More Tiles, 4K Resolution. LED display outdoor resolusi tinggi, brightness tinggi, tahan cuaca IP65 untuk billboard dan signage luar ruang.</p><span class="brand-tag">Mitsubishi</span><span class="brand-tag">Samsung</span></div></div></div>
      <div class="col-md-6 col-lg-4"><div class="prod-card"><img class="prod-card-img" src="https://placehold.co/480x200/e8ecf8/0b1638?text=Video+Wall" alt="Video Wall"/><div class="prod-card-body"><h4>VIDEO WALL</h4><p>Next in display with easy installation of server room to a Video wall. Multi-panel video wall ultra-tipis untuk control room, lobby, dan ruang monitoring 24/7.</p><span class="brand-tag">Samsung</span><span class="brand-tag">LG</span></div></div></div>
      <div class="col-md-6 col-lg-4"><div class="prod-card"><img class="prod-card-img" src="https://placehold.co/480x200/e8ecf8/0b1638?text=Digital+Signage" alt="Digital Signage"/><div class="prod-card-body"><h4>DIGITAL SIGNAGE GATE</h4><p>When your business needs posting with tiles. Solusi papan informasi digital interaktif untuk mall, hotel, perkantoran, dan area publik.</p><span class="brand-tag">LG</span><span class="brand-tag">Samsung</span><span class="brand-tag">NEC</span></div></div></div>
    </div>
  </div>
</section>
