...
<head>
  ...
  <title>Public Address – ATI</title>
...
<section class="prod-section">
  <div class="container">
    <div class="row g-4">
      ...
      <div class="col-md-6 col-lg-4"><div class="prod-card"><img class="prod-card-img" src="https://placehold.co/480x200/e8f0e8/0b2e10?text=IP+PA+System" alt="IP PA"/><div class="prod-card-body"><h4>IP PA SYSTEM</h4><p>Smart Connections, Disaster Connections. Sistem public address berbasis IP untuk broadcasting audio ke seluruh zona gedung secara real-time.</p><span class="brand-tag">Bosch</span><span class="brand-tag">ITC</span></div></div></div>
      <div class="col-md-6 col-lg-4"><div class="prod-card"><img class="prod-card-img" src="https://placehold.co/480x200/e8f0e8/0b2e10?text=Confessional+PA" alt="Confessional PA"/><div class="prod-card-body"><h4>CONFESSIONAL PA SYSTEM</h4><p>Clear Voices, Secure Privacy. Sistem PA konvensional dengan kejernihan suara tinggi dan cakupan area luas untuk gedung publik.</p><span class="brand-tag">TOA</span><span class="brand-tag">Bosch</span></div></div></div>
      <div class="col-md-6 col-lg-4"><div class="prod-card"><img class="prod-card-img" src="https://placehold.co/480x200/e8f0e8/0b2e10?text=Analog+Camera+PA" alt="Analog PA"/><div class="prod-card-body"><h4>ANALOG CAMERA</h4><p>Vehicle Technology, Acoustic, Object Detection, Analytics. Kamera analog berkualitas tinggi untuk monitoring area publik.</p><span class="brand-tag">Pelco</span><span class="brand-tag">Dahua</span></div></div></div>
    </div>
  </div>
</section>
