...
<head>
  ...
  <title>Conference System – ATI</title>
...
<section class="prod-section">
  <div class="container">
    <div class="row g-4">
      ...
      <div class="col-md-6 col-lg-4"><div class="prod-card"><img class="prod-card-img" src="https://placehold.co/480x200/e8f4f8/0b2030?text=Video+Conference" alt="Video Conference"/><div class="prod-card-body"><h4>VIDEO CONFERENCE SYSTEM</h4><p>Integrates all your communication solutions with Advanced Connectivity. Solusi konferensi video HD untuk meeting room modern dengan kamera PTZ dan speaker terintegrasi.</p><span class="brand-tag">Poly</span><span class="brand-tag">Logitech</span><span class="brand-tag">Cisco</span></div></div></div>
      <div class="col-md-6 col-lg-4"><div class="prod-card"><img class="prod-card-img" src="https://placehold.co/480x200/e8f4f8/0b2030?text=Audio+Conference" alt="Audio Conference"/><div class="prod-card-body"><h4>AUDIO CONFERENCE SYSTEM</h4><p>Next in display with wall easy Installation of all components. Sistem konferensi audio jernih dengan microphone array dan noise cancellation.</p><span class="brand-tag">Bosch</span><span class="brand-tag">Shure</span></div></div></div>
      <div class="col-md-6 col-lg-4"><div class="prod-card"><img class="prod-card-img" src="https://placehold.co/480x200/e8f4f8/0b2030?text=Meeting+Room+System" alt="Meeting Room"/><div class="prod-card-body"><h4>MEETING ROOM SYSTEM</h4><p>Smarter Meetings, Better Collaboration. Paket AV lengkap untuk ruang rapat: smart TV, kamera, mikrofon, speaker, dan kontrol terpusat.</p><span class="brand-tag">Crestron</span><span class="brand-tag">Extron</span></div></div></div>
    </div>
  </div>
</section>
