...
<head>
  ...
  <title>Intrusion Alarms – ATI</title>
...
<section class="prod-section">
  <div class="container">
    <div class="row g-4">
      ...
      <div class="col-md-6 col-lg-4"><div class="prod-card"><img class="prod-card-img" src="https://placehold.co/480x200/ede8f5/1a0b38?text=Wireless+Alarm+System" alt="Wireless Alarm"/><div class="prod-card-body"><h4>WIRELESS ALARM SYSTEM</h4><p>Smart Detector, Smart Detection, Smart Warning. Sistem alarm nirkabel dengan PIR sensor, kamera terintegrasi, notifikasi GSM dan aplikasi mobile.</p><span class="brand-tag">Honeywell</span><span class="brand-tag">DSC</span></div></div></div>
      <div class="col-md-6 col-lg-4"><div class="prod-card"><img class="prod-card-img" src="https://placehold.co/480x200/ede8f5/1a0b38?text=Industrial+Alarm+Host" alt="Intrusion Host"/><div class="prod-card-body"><h4>INDUSTRIAL ALARM HOST</h4><p>Wireless Protection, Remote Control, Battery Backup. Panel kontrol alarm pusat multi-zona dengan backup baterai dan koneksi remote monitoring.</p><span class="brand-tag">Bosch</span><span class="brand-tag">Honeywell</span></div></div></div>
    </div>
  </div>
</section>
