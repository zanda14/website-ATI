...
<head>
  ...
  <title>IT Infrastructure – ATI</title>
...
<section class="prod-section">
  <div class="container">
    <div class="row g-4">
      ...
      <div class="col-md-6 col-lg-4"><div class="prod-card"><img class="prod-card-img" src="https://placehold.co/480x200/e8edf8/0b1638?text=Network+Infrastructure" alt="Network"/><div class="prod-card-body"><h4>NETWORK INFRASTRUCTURE</h4><p>Clear Communication, Driving Flexibility, Smarter Connections. Infrastruktur jaringan terstruktur fiber optic, UTP, WiFi enterprise untuk gedung komersial dan industri.</p><span class="brand-tag">Ruijie</span><span class="brand-tag">Cisco</span><span class="brand-tag">Mikrotik</span></div></div></div>
      <div class="col-md-6 col-lg-4"><div class="prod-card"><img class="prod-card-img" src="https://placehold.co/480x200/e8edf8/0b1638?text=Server+Rack+System" alt="Server Rack"/><div class="prod-card-body"><h4>SERVER RACK SYSTEM</h4><p>Secure Your Servers, Power Your Infrastructure. Sistem rak server lengkap dengan UPS, PDU, cooling, dan manajemen kabel profesional.</p><span class="brand-tag">Schneider</span><span class="brand-tag">APC</span><span class="brand-tag">Dell</span></div></div></div>
    </div>
  </div>
</section>
