...
<head>
  ...
  <title>Security Access – ATI</title>
  ...
  <style>
   ...
   rgba(22,45,122,0.65) 100%),
    ...
    .back-btn{display:inline-flex;align-items:center;gap:7px;background:var(--navy);color:#fff;border-radius:24px;padding:8px 20px;font-size:.82rem;font-weight:700;text-decoration:none;transition:background .2s;}
    .back-btn:hover{background:var(--mid);color:#fff;}
...
<section class="prod-section">
  <div class="container">
    <div class="row g-4">
      ...
      <div class="col-md-6 col-lg-4"><div class="prod-card"><img class="prod-card-img" src="https://placehold.co/480x200/f0ede8/2e1e0b?text=Auto+Gate" alt="Auto Gate"/><div class="prod-card-body"><h4>AUTO GATE</h4><p>Smart Sensors, Drive with Confidence, Control. Sistem palang otomatis dengan RFID, remote control, loop detector dan sensor keselamatan.</p><span class="brand-tag">CAME</span><span class="brand-tag">FAAC</span></div></div></div>
      <div class="col-md-6 col-lg-4"><div class="prod-card"><img class="prod-card-img" src="https://placehold.co/480x200/f0ede8/2e1e0b?text=Door+Access" alt="Door Access"/><div class="prod-card-body"><h4>DOOR ACCESS</h4><p>Lifting Device, Security Entry, Access with Confidence. Sistem kontrol akses pintu berbasis fingerprint, face recognition, dan kartu RFID.</p><span class="brand-tag">ZKTeco</span><span class="brand-tag">Hikvision</span></div></div></div>
      <div class="col-md-6 col-lg-4"><div class="prod-card"><img class="prod-card-img" src="https://placehold.co/480x200/f0ede8/2e1e0b?text=Home+Barrier+Gate" alt="Home Barrier"/><div class="prod-card-body"><h4>HOME/BARRIER GATE</h4><p>Smart Backing for a safer Smarter Access. Pintu otomatis untuk residensial dan komersial dengan motor drive dan sensor keamanan.</p><span class="brand-tag">FAAC</span><span class="brand-tag">CAME</span></div></div></div>
      <div class="col-md-6 col-lg-4"><div class="prod-card"><img class="prod-card-img" src="https://placehold.co/480x200/f0ede8/2e1e0b?text=Turnstile+Gate" alt="Turnstile"/><div class="prod-card-body"><h4>TURNSTILE GATE</h4><p>Control Entry, Smart Gate Solid Prime. Flap barrier, tripod, dan full-height turnstile untuk akses kontrol area dengan kapasitas tinggi.</p><span class="brand-tag">ZKTeco</span><span class="brand-tag">Gunnebo</span></div></div></div>
      <div class="col-md-6 col-lg-4"><div class="prod-card"><img class="prod-card-img" src="https://placehold.co/480x200/f0ede8/2e1e0b?text=Sliding+Gate+Operator" alt="Sliding Gate"/><div class="prod-card-body"><h4>SLIDING GATE OPERATOR</h4><p>Strong Performance, DC Motor Fast Automation. Operator pintu geser heavy duty dengan motor DC, anti-crush, dan operasi remote.</p><span class="brand-tag">CAME</span><span class="brand-tag">FAAC</span></div></div></div>
      <div class="col-md-6 col-lg-4"><div class="prod-card"><img class="prod-card-img" src="https://placehold.co/480x200/f0ede8/2e1e0b?text=Metal+Detector" alt="Metal Detector"/><div class="prod-card-body"><h4>METAL DETECTOR</h4><p>Precision, Low Interference, Adjustable Sensitivity. Walk-through dan handheld metal detector multi-zona untuk keamanan gedung dan acara.</p><span class="brand-tag">Garrett</span><span class="brand-tag">Rapiscan</span></div></div></div>
    </div>
  </div>
</section>
